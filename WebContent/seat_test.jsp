...
query1="select seat_no from user_selected where selected_date='"+date_selected+"' and theatre_id="+theatre_id+" "; 
ps1=con1.prepareStatement(query1);
res=ps1.executeQuery();
while(res.next())
{
...
query1="select seat_no from user_selected where selected_date='"+date_selected+"' and show_time_id="+show_time_id+" "; 
ps1=con1.prepareStatement(query1);
res=ps1.executeQuery();
while(res.next())
{
